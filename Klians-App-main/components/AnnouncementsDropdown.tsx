...
export const AnnouncementsDropdown: React.FC<AnnouncementsDropdownProps> = ({ onClose }) => {
  ...
  return (
    <div className="absolute right-0 top-12 w-96 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-slate-200 dark:border-slate-700 z-50">
      {/* Header */}
