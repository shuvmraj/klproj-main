            ...
            {showComments && (
                <div className="px-4 py-3 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                        <Avatar src={user?.avatar} alt="Your avatar" size="sm" />
                        <div className="flex-1 relative">
                            <input
                                ...
                                className="w-full py-2 px-3 bg-slate-100 dark:bg-slate-700 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-red-500"
                                onKeyPress={(e) => e.key === 'Enter' && handleAddComment()}
                            />
                            <button 
                                onClick={handleAddComment}
                                disabled={isCommentLoading || !newComment.trim()}
                                className="absolute right-2 top-1/2 -translate-y-1/2 text-red-500 disabled:text-slate-400"
                            >
